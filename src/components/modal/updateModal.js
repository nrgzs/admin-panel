import { useChangeProductMutation } from '@/services/ProductRTK';
...
const UpdateModal  = ({
 ...
 const [ChangeProduct, { isLoading, isError }] = useChangeProductMutation();

  const [updatedData, setUpdatedData] = useState(itemData || {});
  ...
  const handleUpdate = async() => {
     try {
       const response = await ChangeProduct(updatedData).unwrap();
